...
const PUBLIC_PATHS = ['/login', '/signup', '/api/auth/login', '/api/auth/signup', '/api/auth/logout', '/register', '/api/calendar-sessions', '/api/calendar-bookings', '/api/customers/lookup', '/api/org-invoices', '/api/organizations']
